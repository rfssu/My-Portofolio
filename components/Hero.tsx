    ...
    return (
        <section className="py-20 md:py-32">
            <div className="max-w-4xl">
                ...
                {/* Value Proposition */}
                <p className="text-lg md:text-xl text-slate-700 dark:text-slate-400 leading-relaxed max-w-2xl mb-10">
                ...
                <div className="flex flex-wrap gap-4">
                    <a
                        href="#projects"
                        className="px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold rounded-full hover:bg-slate-800 dark:hover:bg-slate-200 transition-all hover:scale-105 active:scale-95 shadow-lg"
                    >
                        Lihat Proyek
                    </a>
                    <a
